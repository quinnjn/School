...
if (! empty($retarr)) {
  ...
  if ($info['http_code'] == 200 && !empty($body)) {
    print "\nYour auth token and auth token secret are:\n$oauth_token $oauth_token_secret\n";
    print "\nRun the following command:\nphp tweet.php \"Hello World...\" $oauth_token $oauth_token_secret $oauth_consumer_key $oauth_consumer_secret\n";
  }
}
